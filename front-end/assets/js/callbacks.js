window.dash_clientside = Object.assign({}, window.dash_clientside, {
  clientside: {
    ...
    renderChartCardPieChartAnalytics: (data) => {
      let targetIdx = window.dash_clientside.callback_context.inputs_list[0].id.index;
      var myChart = echarts.init(document.getElementById(JSON.stringify({ "index": targetIdx, "type": "analytics-chart-card-pie-chart-container" })));
      var option;
      option = {
        tooltip: {
          trigger: 'item'
    ...
    renderChartCardBarChartAnalytics: (data) => {
      let targetIdx = window.dash_clientside.callback_context.inputs_list[0].id.index;
      var myChart = echarts.init(document.getElementById(JSON.stringify({ "index": targetIdx, "type": "analytics-chart-card-bar-chart-container" })));
      var option;
      option = {
        legend: {
          right: 'top'
    ...
    renderChartCardHBarChartAnalytics: (data) => {
      let targetIdx = window.dash_clientside.callback_context.inputs_list[0].id.index;
      var myChart = echarts.init(document.getElementById(JSON.stringify({ "index": targetIdx, "type": "analytics-chart-card-hbar-chart-container" })));
      var option;
      option = {
        tooltip: {
          trigger: 'axis',
    ...
    renderChartCardRadarChartAnalytics: (data) => {
      let targetIdx = window.dash_clientside.callback_context.inputs_list[0].id.index;
      var myChart = echarts.init(document.getElementById(JSON.stringify({ "index": targetIdx, "type": "analytics-chart-card-radar-chart-container" })));
      var option;
      option = {
        legend: {
          data: data.series,
    ...
    // handleBankingIncomeExpensesSlidingBox: (incomeNClicks, expensesNClicks, style) => {
    //   console.log(incomeNClicks, expensesNClicks, style);
    //   return window.dash_clientside.no_update;
    // },

    handleBankingIncomeExpensesChart: (data) => {
      let targetIdx = window.dash_clientside.callback_context.inputs_list[0].id.index;
      var myChart = echarts.init(document.getElementById(JSON.stringify({ "index": targetIdx, "type": "banking-income-expenses-card-line-chart-container" })));
      var option;
      option = {
        xAxis: {
          type: 'category',
